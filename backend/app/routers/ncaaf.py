"""
NCAAF games router with analysis
"""
...
def load_games_data() -> List[Dict[str, Any]]:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for game in api_games:
                ...
                avg_total = sum(totals) / len(totals) if totals else 51.5
                ...
                games.append({
                    ...
                    "contrarian": False,  # Would need public betting data
            ...
            print(f"✅ Loaded {len(games)} REAL NCAAF games from API")
            return games
    ...
    paths = [
        "data/sample_ncaaf_games.json",  # Docker container path
        "/app/data/sample_ncaaf_games.json",  # Absolute Docker path
        "/Users/sean/Downloads/sean-picks-app/backend/data/sample_ncaaf_games.json",  # Local dev
        "/Users/sean/Downloads/sean_picks/data/ncaaf_odds.json",
        "/Users/sean/Downloads/sean_picks/ncaaf_odds.json"
    ]
...
@router.get("/games")
async def get_ncaaf_games(
    db: Session = Depends(get_db)
):
    """Get NCAAF games with analysis"""
...
async def get_game_details(
    ...
    # Find the game by ID
    game_idx = int(game_id.replace("ncaaf_game_", ""))
    ...
    return {
        ...
        "analysis": {
            ...
            "key_number": abs(game.get("spread", 0)) in [3, 7, 10, 14]
        }
    }